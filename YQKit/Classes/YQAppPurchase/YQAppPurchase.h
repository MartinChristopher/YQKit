...
#pragma mark --------YQAppPurchaseDelegate--内购代理
/**
 *  内购工具的代理
 */
@protocol YQAppPurchaseDelegate <NSObject>
@optional;
/**
 *  代理：系统错误
 */
...
#pragma mark --------YQAppPurchase--内购工具
/**
 *  内购工具
 */
@interface YQAppPurchase : NSObject
 ...
 *  代理
 */
@property (nonatomic, weak) id<YQAppPurchaseDelegate> delegate;
 ...
 *  单例
 *
 *  @return YQAppPurchase
 */
+ (YQAppPurchase *)defaultTool;
